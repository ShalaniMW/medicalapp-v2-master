...
import ListPComponent from './Components/Dashboard/ExternalUser/ListPComponent';

import ListSupplierComponent from './Components/Dashboard/ExternalUser/ListSupplierComponent';
import CreateSupplierComponent from './Components/Dashboard/ExternalUser/CreateSupplierComponent';
import UpdateSupplierComponent from './Components/Dashboard/ExternalUser/UpdateSupplierComponent';
...
function App() {
  return (
    <Router>
      ...
      <AppRoute path = "/extuser/patient-records" layout = {DashboardLayout} component = {ListPComponent} />

      <AppRoute path = "/extuser/suppliers" layout = {DashboardLayout} component = {ListSupplierComponent} />
      <AppRoute path = "/extuser/add-supplier" layout = {DashboardLayout} component = {CreateSupplierComponent} />
      <AppRoute path = "/extuser/update-supplier/:Id" layout = {DashboardLayout} component = {UpdateSupplierComponent} />
