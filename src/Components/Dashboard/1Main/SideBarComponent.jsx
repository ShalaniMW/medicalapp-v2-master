            ...
            <div class="sidebar-sticky">
                <ul class="nav flex-column" style = {{marginTop:"5px"}}>
                    <li className = "nav-item"> 
                        ...
                        <label style = {{margin:"10px"}}>Shelani Wijesekera</label>  </a> 
                    </li>
                </ul>
                ...
                <ul class="nav flex-column">
                    ...
                    <li class = "nav-item dropdown">
   				        ...
   				        <ul class="collapse list-unstyled" id="extDrop">
                            ...
                            <li> <a class = "dropdown-itemm" href="/extuser/patient-records">Patient Records</a> </li>
                            <li> <a class = "dropdown-itemm" href="/extuser/add-supplier">New Supplier</a> </li>
                            <li> <a class = "dropdown-itemm" href="/extuser/suppliers">All Suppliers</a> </li>
   				        </ul>
   			        </li>
                    <li class = "nav-item dropdown">
